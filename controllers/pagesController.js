...
const fs = require('fs');
module.exports = function (_, commonfunction, pagesValidation) {
	return {
		SetRouting: function (router) {
			router.get('/page/add', commonfunction.loginCheck, this.addAction);
			router.get('/page', commonfunction.loginCheck, this.listAction);
			router.get('/page/:id', commonfunction.loginCheck, this.getAction);
			router.get('/page/:id/delete', commonfunction.loginCheck, this.deleteAction);

			router.post('/page/details', commonfunction.loginCheck, this.listDetails);
			router.post('/page/postAdd', pagesValidation.pageValidation, this.postAddAction)
			router.post('/page/postEdit', pagesValidation.pageValidation, this.postEditAction)
		},
		addAction: function (req, res) {
			const errors = req.flash('addPage-error');
			const formData = req.flash('formdata-page');
		...
		postAddAction: function (req, res) {
			...
			if (req.body.page_img_enc) {
				var img = req.body.page_img_enc;
